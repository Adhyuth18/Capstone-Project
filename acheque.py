...
tessaract=r'C:\Program Files\Tesseract-OCR\tesseract'
print(pytessaract.image_to_string(Image.open(r'cheque_images\Cheque 083654.jpg')))
...
for filename in os.listdir(input_path):
    ...
    data = pytessaract.image_to_data(Image.open(os.path.join(input_path,filename)))
    # print (data)
    pleaseCd = [0, 0, 0, 0]
    aboveCd = [0, 0, 0, 0]
